...
_STAGE_SOURCE_PATTERNS: Final[dict[int, tuple[str, ...]]] = {
    0: (
        ...
        "src/param_importance_nlp/{assets,asset_acquisition,asset_layout,asset_requirements,atomic,cache,capacity,cli,environment,git_guard,lifecycle,storage}.py",
        "src/param_importance_nlp/{asset_download_plan,g3_asset_publication,g3_gate,glue_builder}.py",
        "src/param_importance_nlp/data/*.py",
        "src/param_importance_nlp/core/losses.py",
        "src/param_importance_nlp/providers/{pythia_mmap,training}.py",
        "ops/stage0/*.py",
        "ops/stage0/*.ps1",
        "ops/stage0/*.sh",
        "schemas/stage0-asset-manifest-v1.json",
        "configs/stage0/*.json",
        "configs/stage0/http-objects/*.json",
    ),
    1: (
        "docs/mathematics.md",
        "plan/stage1/*.md",
    ...
    2: (
        ...
        "src/param_importance_nlp/providers/fixed_state_torch.py",
        "src/param_importance_nlp/providers/*.py",
    ),
    3: (
        "plan/stage3/*.md",
        ...
        "src/param_importance_nlp/experiments/stage3_formal.py",
        "src/param_importance_nlp/experiments/stage23_task_runners.py",
        "src/param_importance_nlp/experiments/training_endpoints.py",
    ),
    4: (
        "plan/stage4/README.md",
        "src/param_importance_nlp/experiments/stage456_task_runners.py",
        "src/param_importance_nlp/experiments/training_routes.py",
        "src/param_importance_nlp/experiments/task_runners.py",
        "src/param_importance_nlp/runtime/training.py",
    ),
    5: (
        "plan/stage5/README.md",
        "src/param_importance_nlp/experiments/stage456_task_runners.py",
        "src/param_importance_nlp/experiments/training_routes.py",
        "src/param_importance_nlp/experiments/task_runners.py",
        "src/param_importance_nlp/runtime/training.py",
    ...
    6: (
        "plan/stage6/README.md",
        "src/param_importance_nlp/experiments/stage456_task_runners.py",
        "src/param_importance_nlp/experiments/training_routes.py",
        "src/param_importance_nlp/experiments/task_runners.py",
        "src/param_importance_nlp/providers/huggingface_offline.py",
    ),
    7: (
        "plan/stage7/README.md",
        ...
        "src/param_importance_nlp/experiments/pruning_runner.py",
        "src/param_importance_nlp/experiments/stage789_task_runners.py",
    ),
    8: (
        "plan/stage8/README.md",
        "src/param_importance_nlp/experiments/ablation.py",
        "src/param_importance_nlp/experiments/ablation_runner.py",
        "src/param_importance_nlp/experiments/stage789_task_runners.py",
    ),
    9: (
        "plan/stage9/README.md",
        "src/param_importance_nlp/analysis/*.py",
        "src/param_importance_nlp/experiments/stage789_task_runners.py",
        "src/param_importance_nlp/experiments/full_fixture_pipeline.py",
    ),
}
