...
def _publish_dependency(root: Path, ordinal: int, gate_id: str, task_id: str) -> dict[str, str]:
    ...
    index_wires = {
        ...
        "G1-DDP": ("stage1-s1-8-formalization-index-v8", {"fixture_manifest": "fixture-manifest.json", "ddp_report": "ddp-report.json", "array_bundle": "array-bundle.json", "comparison_table": "comparison-table.json", "gate_record": "g1-ddp-record.json"}),
