...
_TASKS_RAW: Final = (
    ...
    _task("stage4.importance_trajectory", "160M 重要性轨迹归约", "plan/stage4/README.md#stage4-importance-trajectory", RunnerKind.STATISTICS, ("importance_trajectory_table", "layer_module_summary"), RecoveryMode.REBUILD_DERIVED, SafeBoundary.CANONICAL_SOURCE, gates=("stage3.G3-8",), estimator_decision=True),
    _task("stage4.pruning_validation", "160M 初步剪枝闭环", "plan/stage4/README.md#stage4-pruning-validation", RunnerKind.PRUNING, ("pruning_plan", "pruning_results", "damage_auc_table"), RecoveryMode.RESUME_SHARDS, SafeBoundary.SHARD_COMMIT, gates=("stage3.G3-8",), capabilities=("server", "cuda", "model_assets", "data_assets"), estimator_decision=True),
    _task("stage4.report", "Stage 4 闭环报告", "plan/stage4/README.md#stage4-report", RunnerKind.REPORTING, ("stage_report", "chart_artifacts", "gate_summary"), RecoveryMode.REBUILD_DERIVED, SafeBoundary.CANONICAL_SOURCE, gates=("stage3.G3-8",), estimator_decision=True),
